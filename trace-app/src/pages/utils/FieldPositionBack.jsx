...
const FIELD_POSITIONS = {
    ...
    pa_dob: { x: 294, y: 407, width: 567 },
    pa_pob: { x: 954, y: 407, width: 876 },
    ...
    dra_attended_by: { x: 1062, y: 2184, width: 945 },
    dra_attendant_address: { x: 399, y: 2244, width: 1620 },
    dra_citizenship: { x: 966, y: 2340, width: 852 },
    dra_marriage_date: { x: 1251, y: 2433, width: 483 },
    dra_marriage_place: { x: 1854, y: 2433, width: 411 },
    dra_father_name: { x: 1521, y: 2628, width: 723 },
    dra_delay_reason: { x: 1488, y: 2715, width: 777 },
    dra_spouse_name: { x: 1191, y: 2868, width: 732 },
    dra_relationship: { x: 1521, y: 2964, width: 402 },
    dra_affixed_day: { x: 1251, y: 3222 },
    dra_affixed_month: { x: 1521, y: 3222, width: 675 },
    dra_affixed_at: { x: 1131, y: 3282, width: 840 },
    dra_sworn_day: { x: 1179, y: 3612 },
    dra_sworn_month: { x: 1488, y: 3612, width: 483 },
    dra_sworn_year: { x: 2043, y: 3612, width: 189 },
    dra_sworn_at: { x: 153, y: 3666, width: 1026 },
    dra_ctc_no: { x: 153, y: 3732, width: 330 },
    dra_issued_on: { x: 732, y: 3732, width: 567 },
    dra_issued_at: { x: 1404, y: 3732, width: 849 },
    dra_admin_officer: { x: 1332, y: 3837, width: 852 },
    dra_position: { x: 1332, y: 3837, width: 852 },
    dra_name_in_print: { x: 282, y: 3966, width: 861 },
    dra_address: { x: 1332, y: 3966, width: 852 },

    // DRA Checkboxes
    dra_chk_self_birth: { x: 387, y: 1947 },
    dra_chk_other_birth: { x: 387, y: 2031 },
    dra_chk_married: { x: 954, y: 2421 },
    dra_chk_not_married: { x: 954, y: 2562 },
};
